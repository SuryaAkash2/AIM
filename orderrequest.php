...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <h5 style="color:white">ORDER&nbspREQUEST </h5>
    <div class="navbar-nav">
    <ul class="navbar-nav1">
    
      <li class="nav-item">
     <h6 style='color:#f5f6f5;'><i class='fa fa-user'>&nbsp FACULTY</h6></i><a class='nav-link' href='logout.php'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspLogout</a>
      </li>
    </ul>
</div>
  </div>
...
<form action="requestorderdata.php" method="post">
