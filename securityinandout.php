...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse justify-content-between" id="menu2">
    ...
    <li><h2 style='color:#f5f6f5;'><i class='fa fa-user'>&nbsp SECURITY </i></h2></li>
    </ul></p>
    <div class="navbar-nav">
    <ul class="navbar-nav1">
    
      <li class="nav-item">
        <h6 style='color:#f5f6f5;'><a class='nav-link' href='logout.php'><i class='fa fa-user'></i>&nbsp&nbspLogout</a></h6>
      </li>
    </ul>
</div>
  </div>
...
<div class="row">
    ...
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
        ...
        <ul class="list-group">
           ...
           <a href="#" class="bg-dark list-group-item list-group-item-action d-flex align-items-center">
            ...
            <a href="securityinandout.php" class="bg-dark list-group-item list-group-item-action d-flex align-items-center">
                <div class="d-flex w-100 justify-content-start align-items-center">
                  <span id="collapse-text" class="menu-collapsed">INWARD<b></b></span>
                </div>
            </a>
            <a href="securityoutandin.php" class="bg-dark list-group-item list-group-item-action d-flex align-items-center">
                <div class="d-flex w-100 justify-content-start align-items-center">
                <span id="collapse-text" class="menu-collapsed active">OUTWARD<b></b></span>
                </div>
            </a>
  ...
  padding: 0.5em 1em;
  width:15%; margin-left: 41%;
  font-size: 1.25em;
  text-align: center;">INWARD</h1><hr>
    </div>
    <a id = "toggle4" data-toggle="collapse" aria-expanded="false" class="bg-dark list-group-item list-group-item-action flex-column align-items-start" style="color:white;">
                <div class="d-flex w-100 justify-content"style="cursor: pointer !important; align-items: center; width:10px;">
                     <span class="menu-collapsed" style="margin-left:45%; ">ADD NEW ENTRY</span>
                </div>
</a>
</center>
<form action="securityinward.php" method="POST">
...
<div class="form-group pull-right" >
    <input type ="text"class="search form-control" placeholder="Search" style="border-color: black !important; height: 10% !important;border-radius: 15px !important;border-color: #333 !important;box-shadow: none !important; border-width: 2px;">
</div>
...
<table class="table table-hover table-bordered results" id="ticketLinesTable">
  ...
  <tbody>
      <?PHP
              $i=1;
             include 'connect.php';
            $query = "SELECT * FROM `ward` WHERE `status` = 'accept'  AND `ward` = 'inward' ORDER BY `sno` DESC" ;
            $sql = mysqli_query($conn, $query);
              while($row = mysqli_fetch_array($sql))
              {
               ...
               echo " <tr><th>".$i."</th><td>".$row['date']."</td><td>".$row['infra']."</td>
                        ...
                        <td>".$row['purpose']."<td>".$row['temper']."</td></tr>";
                        $i++;
              }
         ?>
   </tbody>
