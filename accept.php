...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse justify-content-between" id="menu2">
    ...
    <h5><ul class="navbar-nav">
      ...
      <li class="nav-item">
       <a class="nav-link active" href="accept.php">Accept</a>
      </li>
      <li class="nav-item">
...
<div class="row">
  ...
  padding: 0.5em 1em;
  width:26%; margin-left: 34%;
  font-size: 1.25em;
  text-align: center;">ORDER APPROVAL</h1><hr>

<div class="form-group pull-right" >
    <input type ="text"class="search form-control" placeholder="Search" style="margin-top:0%;border-color: #333 !important; height: 10% !important; border-radius: 15px !important; margin-left: -1% !important; border-width: 2px; border-color: grey; box-shadow: none !important;">
</div>
...
<table class="table table-hover table-bordered results">
  <thead>
    <h6 style="margin-top:3%;"><a href="excelcon.php">Download Data</a></h6><br>
     <tr>
      <th>Sno</th>
      <th>DATE</th>
      <th>FACULTY ID</th>
